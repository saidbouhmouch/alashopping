                  ...
                  <form action="" v-on:submit="save($event)">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                           ...
                           <v-select label="name" id="roles" :options="roles" @input="onSelectedRole"  ></v-select>
                        </div>
                     </div>
                     <div class="row">
                        <div class="form-group col-sm-6">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                           ...
                           <v-select id="countries" label="name" :options="countries" @input="onSelectedCountry"  ></v-select>
                        </div>
                     </div>
                     <div class="row">
                        <div class="form-group col-sm-6">
