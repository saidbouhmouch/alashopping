            ...
            <div class="card">
               <div class="card-body">
                  <form action="" v-on:submit="save($event)">
                     <h4 class="header-title">Type Payment</h4>
                     <div class="row">
                        <div class="col-6 col-sm-4">
                           <upload-image :picture="typePayment.picture.url" @changePicture="onChangePicture($event)"></upload-image>
                        </div>
                     </div>
                     <div class="row">
                        <div class="form-group col-sm-12">
                           <label for="name" class="col-form-label">Name</label>
                           <input class="form-control" required type="text" id="name"  v-model="typePayment.name" >
                        </div>
                     </div>
