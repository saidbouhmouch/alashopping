                  ...
                  <form action="" v-on:submit="update($event)">
                     ...
                     <div class="row">
                        <div class="form-group col-sm-12">
                           ...
                           <input class="form-control" required type="text" id="name"  v-model="category.name" >
                        </div>
                        <div class="form-group col-sm-12">
                           <label for="description" class="col-form-label">Last name</label>
                           <textarea v-model="category.description" class="form-control" rows="3" id="description"></textarea>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="col-5 col-sm-2">
                           <button class="btn btn-flat btn-success mb-3 w-100" type="submit" >
                               <span class="tw-mr-2"> update </span>
