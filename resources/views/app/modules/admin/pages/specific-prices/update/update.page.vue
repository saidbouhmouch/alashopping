                  ...
                  <form action="" v-on:submit="update($event)">
                     ...
                     <div class="row">
                        <div class="form-group col-sm-12">
                           ...
                           <input class="form-control" readonly type="text" id="product"
                              v-model="specificPrice.product.name">
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="form-group col-sm-12">
                           ...
                           <v-select id="discount-type" :value="specificPrice.discountType" :options="discountType" @input="onSelectedDiscountType">
                           </v-select>
                        </div>
                     </div>
