                  ...
                  <form action="" v-on:submit="save($event)">
                     ...
                     <div class="row">
                        <div class="form-group col-sm-12">
                           ...
                           <v-select label="name" id="currencies" :options="currencies" @input="onSelectedCurrency">
                           </v-select>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="form-group col-sm-12">
                           ...
                           <v-select label="name" id="taxes" :options="taxes" @input="onSelectedTaxe"></v-select>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="form-group col-sm-12">
                           ...
                           <v-select multiple label="name" id="tags" :options="tags" @input="onSelectedTag"></v-select>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="form-group col-sm-12">
                           ...
                           <v-select multiple label="name" id="categories" :options="categories"
                        ...
                        <div class="col-6">
                           <div class="custom-control custom-checkbox mr-sm-2">
                              <input type="checkbox" v-model="product.active"
                                 id="customControlShow" class="custom-control-input"> <label
                                 for="customControlShow" class="custom-control-label">show
                                 </label>
                           </div>
                        </div>
                     </div>
