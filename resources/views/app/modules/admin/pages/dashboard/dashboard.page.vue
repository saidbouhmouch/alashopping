                                    ...
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="buy">30% <img src="/img/icon/market-value/triangle-down.png" alt="icon"></td>
                                                <td class="sell">20% <img src="/img/icon/market-value/triangle-up.png" alt="icon"></td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="letest-news mt-5">
                                    <div class="single-post mb-xs-40 mb-sm-40">
                                        <div class="lts-thumb">
                                            <img src="/img/blog/post-thumb1.jpg" alt="post thumb">
                                        </div>
                                    ...
                                    <div class="single-post">
                                        <div class="lts-thumb">
                                            <img src="/img/blog/post-thumb2.jpg" alt="post thumb">
                                        </div>
                                        <div class="lts-content">
                                            <span>Admin Post</span>
                                            <h2><a href="blog.html">Sed ut perspiciatis unde omnis iste.</a></h2>
...
<script lang="ts" src="./dashboard.page.ts" ></script>
